...
const toggleLabel = computed(() =>
  isRegister.value ? 'Inicia sesión' : 'Crea una cuenta'
)
  ...
  <div class="login-root">
    ...
    <aside class="hero-side">
      ...
      <div class="hero-body">
        ...
        <p class="hero-sub">
          Arma tu squad, registra tus check-ins diarios y deja que las
          consecuencias se vuelvan parte del juego.
        </p>
...
.hero-body { animation: fadeUp 0.6s 0.1s ease both; }
...
.stat-num.terracotta { color: #C26F4D; }
.stat-num.sage       { color: #7CA39D; }
.stat-num.amber      { color: #E9C281; }
...
.hero-footer { font-size: 0.7rem; color: #A89C89; }
...
@media (min-width: 1024px) {
  .form-side { padding: 2.5rem; min-height: auto; }
}
...
.mobile-tagline { font-size: 0.8rem; color: #6F6557; margin-top: 0.25rem; }
...
.card {
  ...
  background: #FFFFFF;
  border-radius: 22px;
  box-shadow: 0 4px 32px 0 rgba(42, 37, 31, 0.10);
...
.tab--active {
  background: #FFFFFF;
  color: #2A251F;
  box-shadow: 0 1px 4px 0 rgba(42, 37, 31, 0.10);
}
...
.form-sub { font-size: 0.8125rem; color: #6F6557; margin-top: 0.25rem; }
...
.field-label { font-size: 0.8125rem; font-weight: 600; color: #2A251F; }
...
.field-input::placeholder { color: #A89C89; }
...
.switch-link:hover { color: #C26F4D; }
</style>
